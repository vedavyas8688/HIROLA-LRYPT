  ...
  return (
    <main className="spd">
      <style>{`
        ...
        @media(max-width:1100px){.spd-overview__signal{right:0;width:210px;height:210px}.spd-overview__copy{max-width:720px}}@media(max-width:800px){.spd .spd-wrap{width:min(100% - 40px,1290px)}.spd-benefits__grid,.spd-related__grid,.spd-resources__grid,.spd-highlights__list{grid-template-columns:1fr}.spd-next__inner{align-items:flex-start;flex-direction:column}.spd-table{display:block;overflow-x:auto}.spd-benefits__grid{gap:38px}.spd-hero{display:block;min-height:0;background:#eef5f8}.spd-hero__bg{position:relative;display:block;width:100%;height:auto;aspect-ratio:16/9;object-fit:contain;background:#dce9ef;transform:none!important}.spd-hero::after{content:none}.spd-hero__content{max-width:none;padding-block:34px 46px}.spd-hero h1{line-height:1.2;font-size:clamp(2rem,8vw,2.65rem)}.spd-hero p{max-width:36rem}.spd-overview__signal{display:none}.spd-overview__image{width:100%;margin-top:42px}.spd-suite__body{grid-template-columns:1fr;gap:24px}.spd-suite__tabs{overflow-x:auto;flex-direction:row;border-left:0;border-bottom:1px solid var(--line-cream)}.spd-suite__tabs button{white-space:nowrap;border-left:0;border-bottom:2px solid transparent}.spd-suite__tabs button.is-active{border-left:0;border-bottom-color:var(--black)}}@media(max-width:520px){.spd-hero__bg{aspect-ratio:4/3}.spd-hero__content{padding-block:28px 40px}.spd-primary-btn{width:100%;min-width:0}}
      `}</style>
