    ...
    <main className="lg-scope">
      ...
      <div className="lg-body">
        <nav className="lg-index" aria-label="Table of contents">
          <div className="lg-index-label">On this page</div>
          <ul className="lg-index-list">
            {sections.map((s, i) => (
              <li className="lg-index-item" key={s.id}>
                <a
                  href={`#${s.id}`}
                  className={`lg-index-link${activeId === s.id ? " active" : ""}`}
                >
                  <span className="lg-index-num">
          ...
          {sections.map((s, i) => (
            ...
            >
              <div className="lg-section-head">
                <span className="lg-section-num lg-mono">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <h2 className="lg-section-heading">{s.heading}</h2>
              </div>
              {s.body.map((paragraph, j) => (
                <p className="lg-p" key={j}>
                  {paragraph}
                </p>
              ))}
              {s.bullets && (
      ...
      {crossLinkTo && (
        <footer className="lg-footer">
          <div className="lg-footer-inner">
            <span className="lg-footer-note">Related document</span>
