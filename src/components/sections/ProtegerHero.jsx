  ...
  return (
    <section className={`proteger-hero${scrolled ? " is-scrolled" : ""}`}>
      <style>{`
        ...
        @media(max-width:700px){.proteger-hero{min-height:0;padding:22px 18px 42px;background:#fff}.proteger-hero::after{content:none}.proteger-hero__image,.proteger-hero__video{position:relative;display:block;height:auto;aspect-ratio:16/5;border-radius:16px;object-fit:cover}.proteger-hero__content,.proteger-hero.is-scrolled .proteger-hero__content{position:relative;left:auto;right:auto;bottom:auto;align-items:flex-start;flex-direction:column;width:100%;margin-top:34px;color:var(--ink)}.proteger-hero__brand-logo{min-height:44px;margin-bottom:18px;padding:8px 12px}.proteger-hero__brand-logo img{max-width:150px;max-height:34px}.proteger-hero.is-scrolled .proteger-hero__contact{margin-right:0}.proteger-hero h1{font-size:clamp(2rem,9vw,3.3rem);line-height:1.25;white-space:normal}.proteger-hero__rule{margin-top:18px}.proteger-hero__rule::before{height:4px}.proteger-hero__dots i{width:4px;height:4px}}
      `}</style>
      {video ? (
        <video
