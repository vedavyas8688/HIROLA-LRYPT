  ...
  return (
    <section className={`proteger-hero${scrolled ? " is-scrolled" : ""}`}>
      <style>{`
        ...
        .proteger-hero__content{position:absolute;z-index:1;left:4.2vw;bottom:8%;width:min(760px,88vw);color:#fff}
        .proteger-hero h1{margin:0;font-size:clamp(3.5rem,6vw,6rem);font-weight:700;line-height:1.42;letter-spacing:-.035em;text-transform:none}
        ...
        .proteger-hero.is-scrolled .proteger-hero__content{position:relative;left:auto;bottom:auto;width:100%;margin-top:28px;color:var(--ink)}
        .proteger-hero.is-scrolled h1{font-size:clamp(2.8rem,4vw,4rem);line-height:1.35}
        @media(max-width:700px){.proteger-hero{min-height:0;padding:22px 18px 42px;background:#fff}.proteger-hero::after{content:none}.proteger-hero__image{position:relative;display:block;height:auto;aspect-ratio:16/5;border-radius:16px;object-fit:cover}.proteger-hero__content{position:relative;left:auto;bottom:auto;width:100%;margin-top:34px;color:var(--ink)}.proteger-hero h1{font-size:clamp(2.4rem,10vw,4rem);line-height:1.45}.proteger-hero__rule{margin-top:18px}.proteger-hero__rule::before{height:4px}.proteger-hero__dots i{width:4px;height:4px}}
      `}</style>
