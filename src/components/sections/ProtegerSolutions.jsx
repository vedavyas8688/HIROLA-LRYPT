  ...
  return (
    <section className="proteger-solutions">
      <style>{`
        ...
        .proteger-solutions__title{display:flex;align-items:center;gap:9px;margin-bottom:20px}.proteger-solutions__title h3{margin:0;font-size:clamp(1.45rem,2vw,2rem);text-transform:none}.proteger-solutions__title svg{width:21px;height:21px}
