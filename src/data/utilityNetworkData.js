// Content for the UtilityNetwork page.
...
export const whyLrypt = {
  ...
  variant: "modern",
  label: "Why LRYPT",
  title: "Your Engineering Partner - Not Just Another Vendor",
  desc:
    "LRYPT combines deep engineering expertise with a flexible delivery model to help organisations execute projects with confidence. From engineering design and GIS to telecom, simulation and digital engineering, our multidisciplinary teams integrate seamlessly with yours to deliver high-quality outcomes, faster turnaround and measurable value.",
  bullets: [
    "Access the Right Engineering Expertise: Work with specialists across mechanical, civil, GIS, telecom and digital engineering.",
    "Scale Your Team on Demand: Increase engineering capacity quickly without the time and cost of hiring.",
    "Quality You Can Rely On: Structured delivery processes and rigorous reviews ensure consistent, dependable results.",
    "Deliver More While Spending Less: Optimise project costs through efficient offshore engineering without compromising quality.",
  ],
  bulletStyle: "check",
};
