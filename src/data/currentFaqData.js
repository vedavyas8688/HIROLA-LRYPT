...
export const pageHead = {
  ...
  lead: "Everything you need to know about LRYPT's current solutions, services, and delivery approach.",
};
...
export const faqCategories = {
  categories: [
    ...
    },
    {
      category: "Services",
      items: [
        { q: "What services does LRYPT offer?", a: "We provide utility network services, GIS mapping, FTTx planning, engineering design, simulation, prototyping, documentation, and production-readiness support." },
        { q: "Which utility sectors do you support?", a: "We support FTTx, electric transmission and distribution, water and wastewater, oil and gas pipelines, and smart infrastructure." },
        { q: "What engineering disciplines do you cover?", a: "Our capabilities span mechanical, aerospace, civil, structural, manufacturing, and multidisciplinary product engineering." },
        { q: "Can you act as an outsourced delivery team?", a: "Yes. Our specialists can work as an extension of your team and deliver standards-compliant, client-ready project outputs." },
      ],
    },
    {
      category: "Contact & Getting Started",
      items: [
        { q: "How can I contact LRYPT Technologies?", a: "Call 9036354564, email enquiry@lrypt.com, or submit the enquiry form on our Contact page." },
        { q: "What are your business hours?", a: "Monday to Friday, 9:00 AM to 6:30 PM IST." },
        { q: "Can I request a quote or demonstration?", a: "Yes. Share your requirements with our team and we will recommend the appropriate next step, demonstration, or tailored quotation." },
      ],
    },
  ],
};
